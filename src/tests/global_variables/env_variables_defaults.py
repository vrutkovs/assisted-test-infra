...
class _EnvVariables(DataPool, ABC):
    ...
    nutanix_prismcentral_address: str = EnvVar(["NUTANIX_PRISMCENTRAL_ADDRESS"])
    nutanix_prismcentral_port: EnvVar = EnvVar(["NUTANIX_PRISMCENTRAL_PORT"])
    nutanix_prismcentral_username: EnvVar = EnvVar(["NUTANIX_PRISMCENTRAL_USERNAME"])
    nutanix_prismcentral_password: EnvVar = EnvVar(["NUTANIX_PRISMCENTRAL_PASSWORD"])
    nutanix_prismelement_address: EnvVar = EnvVar(["NUTANIX_PRISMELEMENT_ADDRESS"])
    nutanix_prismelement_port: EnvVar = EnvVar(["NUTANIX_PRISMELEMENT_PORT"])
    nutanix_prismelement_uuid: EnvVar = EnvVar(["NUTANIX_PRISMELEMENT_UUID"])
    nutanix_prismelement_name: EnvVar = EnvVar(["NUTANIX_PRISMELEMENT_name"])
    nutanix_subnet_uuid: EnvVar = EnvVar(["NUTANIX_SUBNET_UUID"])
